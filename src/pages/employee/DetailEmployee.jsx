                ...
                <div className="p-4 sm:p-6">
                    ...
                    <div className="hidden md:block">
                        <div className="flex gap-6 items-center justify-around p-4 rounded-lg shadow-sm">
                            <div className="flex flex-col items-center gap-2">
                                ...
                                <p className="text-base text-gray-500">{t("employee_detail")}</p>
                            </div>
                            <div className="flex flex-col gap-2 text-left">
                                ...
                                {/* <div>
                                    ...
                                    <p className="text-base text-gray-800">{employeeData.phone}</p>
                                </div>
                                <div>
                                    <p className="text-base text-gray-500">{t("role")}</p>
                                    <p className="text-base text-gray-800">{employeeData.role}</p>
                                </div> */}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="md:hidden space-y-4">
                        <div className="flex flex-col items-center gap-3">
                            ...
                            <p className="text-base text-gray-500">{t("employee_details")}</p>
                        </div>
                        <div className="bg-gray-50 p-4 rounded-md shadow-inner space-y-3">
                            ...
                            <div>
                                ...
                                <span className="text-base font-medium text-gray-800">{employeeData.email}</span>
                            </div>
                            <div>
                                <span className="text-base text-gray-500 block">{t("phone")}:</span>
                                <span className="text-base font-medium text-gray-800">{employeeData.phone}</span>
                            </div>
                             <div>
                                <span className="text-base text-gray-500 block">{t("role")}:</span>
                                <span className="text-base font-medium text-gray-800">{employeeData.role}</span>
                            </div>
                        </div>
                    </div>
                </div>
