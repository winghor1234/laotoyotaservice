...
const ReturnPoint = ({ show, onClose, Id, handleFetch }) => {
    ...
    const handleConfirm = async (id) => {
        try {
            setLoading(true);
            await axiosInstance.put(APIPath.RETURN_POINT_GIFT_HISTORY(id));
            SuccessAlert(t("return_point_success"), 1500, "success");
            onClose();
            handleFetch();
        } catch (error) {
            console.error(error);
